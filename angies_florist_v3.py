    ...
    for o in production:
        ...
        with st.expander(f"🌸 {order_code} — {o['customer_name']} | {str(o.get('target_date',''))[:10]} | {florist}"):
            ...
            print_html = (
                ...
                ".inspo-grid { display: grid; gap: 4px; margin-top: 4px; }"
                ".inspo-grid img { width: 100%; max-height: 120px; object-fit: contain; border-radius: 4px; border: 1px solid #e8d0dc; display: block; }"
